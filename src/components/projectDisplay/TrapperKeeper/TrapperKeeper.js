...
import trapper from '../../../assets/trapper.gif'
...
export default class PicYourLandmark extends Component {
  ...
  render() {
    ...
    return (
      ...
      <article id="card-3" className="Card" >
        <h1 className='card-header'>Trapper Keeper</h1>
        {/* <div className='content-container'> */}
        <div className='info-container'>
          <div className='demo-container'>
            <img src={trapper} className='site' alt="This will display an animated GIF" />
          </div>
          <div className='info'>
            <h3>Description</h3>
